...
describe('indexOf', () => 
{
    ...
    it('when called on a collection containing multiple elements that satisfy the predicate then returns the index of the first one', () => 
    {
        let arr = col.toArray();
        let col2 = new Linq(arr.concat(arr));
        let results = col2.indexOf(x => x > 2);
